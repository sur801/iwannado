...
static Elm_Genlist_Item_Class *_set_genlist_item_class(const char *style)
{
	...
	} else if (!strcmp(style, "greeting.title")) {
		item_class->item_style = "title";
		item_class->func.text_get = data_get_greeting_title_text;
	} else if (!strcmp(style, "qanda.title")) {						//qanda
		item_class->item_style = "title";
		item_class->func.text_get = data_get_qanda_title_text;
	...
	} else if (!strcmp(style, "greeting.1text")) {					//qanda
		item_class->item_style = "1text";
		item_class->func.text_get = data_get_greeting_text;
	} else if (!strcmp(style, "qanda.1text")) {						//mart
		item_class->item_style = "1text";
		item_class->func.text_get = data_get_qanda_text;
