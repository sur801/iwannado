...
const char *get_text_to_speech(int index, void* user_data) {
	...
	if (!strcmp(style, "greeting")) {
		return data_get_greeting_text((void *)index, NULL, "elm.text");
	} else if (!strcmp(style, "qanda")) {
		return data_get_qanda_text((void *)index, NULL, "elm.text");
